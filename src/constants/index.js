...
const SPELLING_DICTIONARIES_PATH = () =>
  path.join(USER_DATA_PATH(), "dictionaries");
const SUPPORTED_LANGUAGES_PATH = () =>
  path.join(SPELLING_DICTIONARIES_PATH(), "supported-languages.json");
